...
public class CatalogItemDeleteBean {
	...
	@Inject
	private CatalogItemFromBean catalogItemFormBean;
	...
	public CatalogItemFromBean getCatalogItemFormBean() {
		return catalogItemFormBean;
	}

	public void setCatalogItemFormBean(CatalogItemFromBean catalogItemFormBean) {
